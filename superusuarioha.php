                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="rif-proveedor" name='rif' placeholder="ejemplo j-298400870">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombre-Proveedor" name='nombre' placeholder="nombre del proveedor">
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="dirreccion-Proveedor" name='dirreccion' placeholder="Ejemplo Andres Eloy Blanco, Calle el Palmar, Ciudad Bolívar, Venezuela">
